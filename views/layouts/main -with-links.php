      ...
      <div class="nav-wrapper">
        <ul class="nav-list">
          ...
          <li class="list-item list-item--active">
            <a href="<?=Url::to(['/user/edit&id='.Html::encode(Yii::$app->user->id)])?>" class="link link--nav">Настройки</a>
          </li>
        </ul>
      </div>    <?php endif; ?>
  </nav>
    ...
    <div class="user-block">
        ...
        <div class="user-menu">
            ...
            <div class="popup-head">
                <ul class="popup-menu">
                    <li class="menu-item">
                        <a href="<?=Url::to([['/user/edit&id='.Html::encode(Yii::$app->user->id)]])?>" class="link">Настройки</a>
                    </li>
                    <li class="menu-item">

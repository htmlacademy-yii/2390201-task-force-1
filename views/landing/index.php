  ...
  <header class="page-header page-header--index">
    <div class="main-container page-header__container page-header__container--index">
      ...
      <div class="header__account--index">
        ...
        или
        <a href="<?= Yii::$app->urlManager->createUrl(['signup']) ?>" class="header__account-registration">
          Регистрация
        </a>
      </div>
    </div>
  ...
  <main>
    <div class="landing-container">
      <div class="landing-top">
        ...
        <a href="<?= Yii::$app->urlManager->createUrl(['signup']) ?>" class="button">
          Создать аккаунт
        </a>
      </div>
    ...
    <div class="main-container page-footer__container">
      ...
      <div class="page-footer__links">
        <ul class="links__list">
          ...
          <li class="links__item"><a href="<?= Yii::$app->urlManager->createUrl(['signup']) ?>">Регистрация</a></li>
  ...
  <section class="modal enter-form form-modal" id="enter-form">
    ...
    <?php $form = ActiveForm::begin([
      ...
      <?= $form->field($loginForm, 'email', [
        ...
        'inputOptions' => ['class' => 'enter-form-email input input-middle', 'autofocus' => true],
